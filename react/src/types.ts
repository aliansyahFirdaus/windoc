export type EditorInstance = {
  command: {
    ...
    executeImage: (options: { value: string; width: number; height: number }) => void
    executeHyperlink: (options: { url: string; valueList: { value: string; size: number }[] }) => void
    executeSeparator: (payload: number[], option?: { lineWidth?: number; color?: string }) => void
    ...
    executeDeleteElementById: (options: { id?: string; conceptId?: string }) => void
    getOptions: () => { header: { disabled: boolean }; footer: { disabled: boolean }; [key: string]: unknown }
    ...
    getValue: () => { version: string; data: { header?: object[]; main: object[]; footer?: object[] }; options: object }
    executeSetValue: (payload: { header?: object[]; main?: object[]; footer?: object[] }) => void
    getHTML: () => { header: string; main: string; footer: string }
    executeSetHTML: (payload: { header?: string; main?: string; footer?: string }) => void
    getImage: (payload?: { pixelRatio?: number; mode?: string }) => Promise<string[]>
    getControlValue: (options?: object) => Array<{ conceptId?: string; value: string | null; extension?: unknown }>
