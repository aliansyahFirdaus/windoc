        ...
        <>
          ...
          >
            ...
            <div className="wm-panel-body">
              ...
              <div className="wm-panel-field">
                <label>
                  Opacity <span className="wm-panel-value">{opacity}%</span>
                </label>
                <input
                  type="range"
                  min={0}
              ...
              <div className="wm-panel-field">
                <label>
                  Rotation <span className="wm-panel-value">{rotation}°</span>
                </label>
                <input
                  type="range"
                  min={-90}
            ...
            <div className="wm-panel-actions">
              <button className="wm-panel-btn-delete" onClick={handleDelete}>
                Remove
              </button>
              <button className="wm-panel-btn-apply" onClick={handleApply}>
                Apply
              </button>
            </div>
          </div>
